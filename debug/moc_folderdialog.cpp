...
QT_MOC_LITERAL(1, 13, 17), // "createdFolderList"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 4), // "list"
QT_MOC_LITERAL(4, 37, 6) // "accept"

    },
    "FolderDialog\0createdFolderList\0\0list\0"
    "accept"
};
...
void FolderDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        FolderDialog *_t = static_cast<FolderDialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->createdFolderList((*reinterpret_cast< QStringList(*)>(_a[1]))); break;
        ...
        {
            typedef void (FolderDialog::*_t)(QStringList );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FolderDialog::createdFolderList)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject FolderDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_FolderDialog.data,
      qt_meta_data_FolderDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *FolderDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_FolderDialog.stringdata0))
        return static_cast<void*>(const_cast< FolderDialog*>(this));
...
// SIGNAL 0
void FolderDialog::createdFolderList(QStringList _t1)
{
